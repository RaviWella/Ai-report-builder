...
**Primary Key:** bank_branch_sk  
**Business Key:** source_bank_branch_id, source_bank_id  
**SCD Type:** N/A  
**Refresh Type:** Batch  
...
| `branch_code` | text | Yes | - | TBD | TBD | TBD | No | No | TBD |
| `branch_name` | text | Yes | - | TBD | TBD | TBD | No | No | TBD |
